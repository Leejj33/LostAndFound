		...
		<div class="col-lg-10">
			<div class="jumbotron" style="padding-top: 1px;">
				...
				<form name=c_commentUpdate>
					<input type="text" id="update" style="width: 400px; height: 50px;" maxlength=1024 value="<%= commentText %>"> <input type="button" onclick="send(<%= boardID %>, <%= bbsID %>, <%= commentID %>)" value="수정">
				</form>
			</div>
		</div>
