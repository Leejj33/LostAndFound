...
<body>
				...
				<li>
					<form id="search-main" action="searchBbs.jsp">
						<div class="search-bar">
							<input type="text" name="search" id="search-input" placeholder="  분실물을 검색해보세요." autocomplete='off' style="font-size: 17px;"> <input type="hidden" name="boardID" value="1">
	...
	<div class="container">
		...
		<div class="row">
			...
			<form action="searchBbs.jsp" style="display: inline" autocomplete='off'>
